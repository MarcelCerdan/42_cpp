...
AForm::AForm(void) : name("A38 pass"), isSigned(false), gradeToSign(150), gradeToExecute(150) {

	return ;
}

AForm::AForm(std::string name, int grSign, int grExec) : name(name), isSigned(false),
